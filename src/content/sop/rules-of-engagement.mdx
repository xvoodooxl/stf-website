...
> ROE can be active **platoon-wide**, per **section**, or even per **fireteam**, and may change mid-mission.
...
> Unnecessary engagements break immersion, risk friendly fire, and may compromise the mission.
...
- Use **verbal commands** or hand signals to control detainees. (See [Common Phrases](/sop/communications/multilingual-operations/common-phrases))
...
> A hostile 10 meters from you takes priority over a sniper at 400 meters.
...
> Reports should include **sign**, **action**, **range**, and **direction** when possible.
