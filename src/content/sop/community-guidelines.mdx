...
- No intentional mic peaking, hindering soundboard use, or needlessly using the gun range.
...
- Ideas are welcome when asked, but once a decision is made by a team lead it must be followed: Their word is LAW.
...
- **Debriefing** - Everyone will return to the equipment room and team leads will recap positives and negatives about the operation.

> (This process will naturally repeat until operations cease for any reason - namely scheduled events or a lack of activity)
