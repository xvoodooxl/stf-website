...
- Pull call / Last man (**IR Illuminator / Flashlight**): Blinking light at the individual until they pull. When under nods, once the individual pulls, shine IR Laser so they don't accidentally cross the line of fire. 
> Include example gif here
...
- Direction of travel (used by TL) (**IR Illuminator / Flashlight**): Solid light in the direction of travel, only goes off once the majority of the stack is moving in that direction.
...
> Include images here
- Request for a Fragmentation Grenade: (**IR Laser / Visible Laser**): Circle (lasso) above the door.
- Negative response for Fragmentation Grenade: (**IR Laser / Visible Laser**): Solid laser on top of the door (hold 2 seconds).
