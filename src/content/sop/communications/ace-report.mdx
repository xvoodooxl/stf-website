...
- **GREEN**: You are at your max - Fully effective.
- **YELLOW**: You are above half load - Still effective to continue.
- **RED**: You are at or below half load - May not be able to continue without resupply.
...
<Callout type='info'>
  You may notice that this differs from usual military doctrine, for the sake of
  brevity the fireteam/squad lead will use a color to convey the status of his
  team, not describing the status of each individual section of the ACE report.
</Callout>
