...
Radio communication is a vital to relay information from one element to another. Because of this the following protocol should be used at all times to ensure that the radio communication is concise, accurate, and understandable.
...
## Radio Protocol
    ...
    - Use slow, clear speech, use plain words.
    ...
    - Only follow your leader’s orders, not leader’s leader
