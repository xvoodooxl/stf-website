...
- Grenade into the room if we know for sure who is inside, and we don't want them to live. (*This is covered in Advanced CQB Training*)
- A breaching charge on the door to facilitate a violent/surprise entry. Usually done of the first door we enter, or on doors where stacking is not practical. Team lead will call for a breaching charge when needed. (*This is covered in Advanced CQB Training*)
...
2. Point man will step out of the wall and slightly into the threshold to allow a good angle for two man. He will not move from this position until the flashbang is in the room.
