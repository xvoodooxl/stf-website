...
- Consistent naming allows cross-element coordination, especially in [multi-section ops](/sop/communications/advanced-coordination/multi-section-comm)
...
- Use visual markers, smoke, or other signals if radio is lost ([see: Comms Failure Protocols](/sop/communications/advanced-coordination/comms-failure-protocols))
