...
- Set up multiple pieces of simulated cover (rocks, walls, trees) and practice moving between them while minimizing exposure.
- Practice using concealment to approach a target location unseen.
- Practice deploying smoke to cover a movement or extraction drill.
- Conduct drills under different lighting conditions to practice adapting concealment techniques.
