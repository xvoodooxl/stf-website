...
- **Concealment Movement Drill**: Practice moving a full section across open or semi-open terrain using terrain masking and appropriate formations.
- **Posture Discipline Drill**: Practice adjusting posture based on available cover or enemy threat.
- **Smoke Deployment Drill**: Practice coordinated smoke deployment to cover section movement across a danger zone.

## Quick Reference Table

| Movement Aspect          | Best Practice                      | Key Points                               |
| :----------------------- | :--------------------------------- | :--------------------------------------- |
| Route Selection          | Use terrain masking                | Move through cover and low ground        |
| Formation Selection      | Adapt to terrain                   | Wedge, column, diamond, as needed        |
| Posture Management       | Adjust based on exposure           | Crouched or prone if needed              |
| Use of Smoke             | When no natural concealment exists | Screen enemy view, not friendly movement |
| Communication Discipline | Use hand signals when possible     | Minimize noise and chatter               |
