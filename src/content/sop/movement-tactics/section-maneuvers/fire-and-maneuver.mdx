...
- **Fire and Maneuver Live Drill**: Suppression and movement alternating between two teams.
- **Four F’s Drill**: Practice full sequence from Find, Fix, Flank, Finish in training scenarios.
- **Communication Drill Under Fire**: Practice clear movement calls and coordination during simulated engagements.
...
| Phase     | Action                      | Notes                             |
| :-------- | :-------------------------- | :-------------------------------- |
| 1. Find   | Locate enemy                | Observation or contact            |
| 2. Fix    | Suppress enemy              | Prevent enemy movement            |
| 3. Flank  | Maneuver to enemy side/rear | Use cover and bounding if needed  |
| 4. Finish | Eliminate enemy             | Overwhelm with superior firepower |
