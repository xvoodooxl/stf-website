...
- **Soft Contact Drill**: Practice observing, reporting, and reacting to soft contacts without detection.
- **RCR Reaction Drill**: Practice immediate return fire, sprint to cover, and accurate fire under stress.
- **Fire and Maneuver Drill**: Practice setting a base of fire while the other team flanks or peels.

## Quick Reference Table

| Contact Type | Immediate Reaction                              | Follow-Up                                    |
| :----------- | :---------------------------------------------- | :------------------------------------------- |
| Soft Contact | Move to cover, observe, report                  | Await leader decision                        |
| Hard Contact | RCR: Return Fire → Cover → Return Accurate Fire | Establish base of fire, maneuver or withdraw |
