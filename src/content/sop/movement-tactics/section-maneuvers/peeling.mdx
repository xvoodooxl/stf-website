...
> 📸 **Already Provided Image**: Right Peel movement visualization.
...
> 📸 **Already Provided Image**: Center Peel visualization.
...
- **Basic Peeling Drill**: Practice right peel movement with short, controlled bounds and constant suppression.
- **Center Peel Drill**: Practice rearward withdrawal under suppression pressure.

---

## Quick Reference Table

| Peel Type              | Best Use Case                | Key Notes                                    |
| :--------------------- | :--------------------------- | :------------------------------------------- |
| Right Peel (Lateral)   | Move perpendicular to threat | Used when flank or side movement is possible |
| Center Peel (Rearward) | Withdraw directly backward   | Used when trapped frontally                  |
