...
## Optional: Signals (Contextual Use)

> While most supported games do not allow for true hand signals, you may use **verbal shorthand** or **preset in-game gestures** or mechanics (light blinks, smoke if available) for:
